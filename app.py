...
class AvatarGenerator:
    def __init__(self):
        ...
        "nitrosocke/Ghibli-Diffusion", torch_dtype=torch.float32, use_safetensors=True,safety_checker =None,requires_safety_checker = False
        )
...
if submit_button:
    ...
    st.text("originl Image")
    st.image(image_file)

    # Display the avatar image
    st.text("Generated Avatar")
    st.image(avatar)